...
const argv = yargs
  .option('createCommonResourcesStack', { type: 'boolean', default: false })
  .option('createSequencerMainStack', { type: 'boolean', default: false })
  .option('createSequencerTestStack', {
    type: 'boolean',
    default: false
  })
  .option('createCircuitMainStack', { type: 'boolean', default: false })
  .option('createCircuitTestStack', {
    type: 'boolean',
    default: false
  })
  .parseSync()
...
let commonResourcesStack
if (argv.createCommonResourcesStack) {
  ...
  commonResourcesStack = new CommonResourcesStack(app, 'CommonResourcesStack', {
...
if (argv.createSequencerMainStack && commonResourcesStack) {
...
if (argv.createSequencerTestStack && commonResourcesStack) {
...
if (argv.createCircuitMainStack && commonResourcesStack) {
...
if (argv.createCircuitTestStack && commonResourcesStack) {
